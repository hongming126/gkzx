package com.education.gkzx.test.server;
...
public class JettyServer {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length > 0) {
            contextPath = args[0];
        } else if (StringUtils.isNotBlank(System.getProperties().getProperty("jetty.context"))) {
            contextPath = System.getProperties().getProperty("jetty.context");
        }
    ...
    public void initWebApp(String root, String projectName) throws Exception {
        ...
        // Webapp目录
        String webAppPath = root + projectName + "-web" + "/" + "src" + "/" + "main" + "/"
                + "webapp";
        // 运行后的contextPath
    ...
    private String[] getConstantClassesPath(String baseDir, String projectName) {
        return new String[] { baseDir + "/"
                + projectName + "-web" + "/" + "target" + "/" + "classes",
